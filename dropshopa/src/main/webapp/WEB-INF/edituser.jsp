...
<body class="js" style="height: auto">
	...
	<div class="container rounded bg-white mt-5 mb-5">
		<form:form action="/edit/${user.id}" method="post"
			modelAttribute="user">
			...
			<div class="row">
				<div class="col-md-3 border-right">
					<div
						...
						<img class="rounded-circle mt-5" width="150px"
							src="${user.image }"><span class="font-weight-bold">${user.username }</span>
					</div>
				</div>
				<div class="col-md-5 border-right">
					<div class="p-3 py-5">
						...
						<div class="row mt-2">
							<div class="col-md-6">
								<form:label path="username" class="labels">Name</form:label>
								<form:input type="text" class="form-control"
									placeholder="Full name" path="username" />
								<form:errors path="username" class="error" style="color:red" />
							</div>
						</div>
						<div class="row mt-3">
							<div class="col-md-12">
								<form:label path="phonenumber" class="labels">Mobile Number</form:label>
								<form:input type="text" class="form-control"
									placeholder="enter phone number" path="phonenumber" />
								<form:errors path="phonenumber" class="error" style="color:red" />
							</div>
							<div class="col-md-12">
								<form:label path="adress" class="labels">Address </form:label>
								<form:input type="text" class="form-control"
									placeholder="enter address" path="adress" />
								<form:errors path="adress" class="error" style="color:red" />
							</div>
							<div class="col-md-12">
								<form:label path="image" class="labels">image URL</form:label>
								<form:input type="text" class="form-control"
									placeholder="Image URL" path="image" />
								<form:errors path="image" class="error" style="color:red" />
							</div>
							<div class="col-md-12">
								<form:label path="email" class="labels">Email </form:label>
								<form:input type="text" class="form-control"
